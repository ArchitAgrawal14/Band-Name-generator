...
app.post("/submit", (req, res) => {
  const randomIndexNumForAdj=adj[Math.floor(Math.random()*adj.length)];
  const randomIndexNumForNoun=noun[Math.floor(Math.random()*noun.length)];
  res.render("index.ejs",{
    randomNameadj:randomIndexNumForAdj,
    randomNamenoun:randomIndexNumForNoun,
  });
